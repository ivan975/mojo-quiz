            ...
            <div class="max-w-xl sm:mx-auto lg:max-w-2xl">
                ...
                <div class="space-y-4">
                    <Item title="Purpose of react router">
                        In single page application, react router is needed to to navigate through pages
                    </Item>
                    <Item title="How does context api works?">
                        We create context in a variable and we can pass initial value to prop when we call
                    </Item>
